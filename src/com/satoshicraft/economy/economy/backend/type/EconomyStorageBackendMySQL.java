...
public class EconomyStorageBackendMySQL extends EconomyStorageBackendCaching {
    ...
    private void upgradeSchema1To2(Connection conn) throws SQLException {
        SatoshiEconomy.logger().info("Upgrading database schema from version 1 to version 2. This might take a little while...");
        ...
        reloadDatabase();
        SatoshiEconomy.logger().info("Schema upgrade complete!");
    }
