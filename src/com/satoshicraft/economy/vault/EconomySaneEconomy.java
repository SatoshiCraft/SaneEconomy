...
public class EconomySaneEconomy implements Economy {
    ...
    public boolean isEnabled() {
        return SatoshiEconomy.getInstance().isEnabled();
    }
    ...
    public int fractionalDigits() {
        return SatoshiEconomy.getInstance().getEconomyManager().getCurrency().getFormat().getMaximumFractionDigits();
    }

    @Override
    public String format(double v) {
        return SatoshiEconomy.getInstance().getEconomyManager().getCurrency().formatAmount(v);
    }

    @Override
    public String currencyNamePlural() {
        return SatoshiEconomy.getInstance().getEconomyManager().getCurrency().getPluralName();
    }

    @Override
    public String currencyNameSingular() {
        return SatoshiEconomy.getInstance().getEconomyManager().getCurrency().getSingularName();
    }
    ...
    public boolean hasAccount(String playerName) {
        ...
        return SatoshiEconomy.getInstance().getEconomyManager().accountExists(economable);

    }

    @Override
    public boolean hasAccount(OfflinePlayer offlinePlayer) {
        return SatoshiEconomy.getInstance().getEconomyManager().accountExists(Economable.wrap(offlinePlayer));
    }
    ...
    public double getBalance(String playerName) {
        ...
        return SatoshiEconomy.getInstance().getEconomyManager().getBalance(economable);
    }

    @Override
    public double getBalance(OfflinePlayer offlinePlayer) {
        return SatoshiEconomy.getInstance().getEconomyManager().getBalance(Economable.wrap(offlinePlayer));
    }
    ...
    public boolean has(String playerName, double v) {
        ...
        return SatoshiEconomy.getInstance().getEconomyManager().hasBalance(economable, v);
    }

    @Override
    public boolean has(OfflinePlayer offlinePlayer, double v) {
        return SatoshiEconomy.getInstance().getEconomyManager().hasBalance(Economable.wrap(offlinePlayer), v);
    }
    ...
    private EconomyResponse transact(Transaction transaction) {
        TransactionResult result = SatoshiEconomy.getInstance().getEconomyManager().transact(transaction);
